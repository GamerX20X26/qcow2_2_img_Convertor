...
## Features
* **Interactive Menu:** Easily switch between creating new images or converting existing ones.
...
* **Clean Fallbacks:** Safe to run from any folder once QEMU is added to your system environment variables.
...
## Usage
1. Download `qcow2-img Convertor.cmd` and place it in your scripts folder.
2. Run the script.
3. Follow the on-screen prompts to create or convert your virtual hard drives.
